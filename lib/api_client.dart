...
class ApiClient {
  ...
  ApiClient({this.basePath: "http://127.0.0.1:8000/en/api"}) {
  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'ChildPage':
          return new ChildPage.fromJson(value);
        case 'Comment':
        ...
        case 'PostOutput':
          return new PostOutput.fromJson(value);
        case 'PostUpdate':
          return new PostUpdate.fromJson(value);
        case 'RecursiveField':
          return new RecursiveField.fromJson(value);
        case 'Site':
